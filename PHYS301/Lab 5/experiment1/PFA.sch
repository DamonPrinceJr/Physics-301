...
<drawing version="7">
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <branch name="Bin(0)">
            <attrtext style="alignment:SOFT-BCENTER;fontsize:28;fontname:Arial" attrname="Name" x="698" y="544" type="branch" />
            <wire x2="698" y1="544" y2="544" x1="432" />
            <wire x2="840" y1="544" y2="544" x1="698" />
            <wire x2="976" y1="544" y2="544" x1="840" />
        </branch>
        <branch name="Bin(1)">
            <attrtext style="alignment:SOFT-BCENTER;fontsize:28;fontname:Arial" attrname="Name" x="678" y="800" type="branch" />
            <wire x2="678" y1="800" y2="800" x1="432" />
            <wire x2="704" y1="800" y2="800" x1="678" />
            <wire x2="704" y1="800" y2="816" x1="704" />
            <wire x2="976" y1="816" y2="816" x1="704" />
        </branch>
        <branch name="Bin(2)">
            <attrtext style="alignment:SOFT-BCENTER;fontsize:28;fontname:Arial" attrname="Name" x="686" y="1104" type="branch" />
            <wire x2="686" y1="1104" y2="1104" x1="432" />
            <wire x2="960" y1="1104" y2="1104" x1="686" />
        </branch>
        <branch name="Bin(3)">
            <attrtext style="alignment:SOFT-BCENTER;fontsize:28;fontname:Arial" attrname="Name" x="657" y="1344" type="branch" />
            <wire x2="657" y1="1344" y2="1344" x1="432" />
            <wire x2="960" y1="1344" y2="1344" x1="657" />
        </branch>
        ...
        <branch name="Ain(0)">
            <attrtext style="alignment:SOFT-BCENTER;fontsize:28;fontname:Arial" attrname="Name" x="772" y="608" type="branch" />
            <wire x2="772" y1="608" y2="608" x1="624" />
            <wire x2="976" y1="608" y2="608" x1="772" />
        </branch>
        <branch name="Ain(1)">
            <attrtext style="alignment:SOFT-BCENTER;fontsize:28;fontname:Arial" attrname="Name" x="709" y="912" type="branch" />
            <wire x2="709" y1="912" y2="912" x1="624" />
            <wire x2="800" y1="912" y2="912" x1="709" />
            <wire x2="800" y1="880" y2="912" x1="800" />
            <wire x2="976" y1="880" y2="880" x1="800" />
        </branch>
        <branch name="Ain(2)">
            <attrtext style="alignment:SOFT-BCENTER;fontsize:28;fontname:Arial" attrname="Name" x="698" y="1184" type="branch" />
            <wire x2="698" y1="1184" y2="1184" x1="624" />
            <wire x2="784" y1="1184" y2="1184" x1="698" />
            <wire x2="784" y1="1168" y2="1184" x1="784" />
            <wire x2="960" y1="1168" y2="1168" x1="784" />
        </branch>
        <branch name="Ain(3)">
            <attrtext style="alignment:SOFT-BCENTER;fontsize:28;fontname:Arial" attrname="Name" x="749" y="1408" type="branch" />
            <wire x2="749" y1="1408" y2="1408" x1="624" />
            <wire x2="928" y1="1408" y2="1408" x1="749" />
